...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'dist/output.data';
...
Module['FS_createPath']("/usr", "games", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_dist/output.data');

      };
      Module['addRunDependency']('datafile_dist/output.data');
    ...
    loadPackage({"files": [{"filename": "/etc/termcap", "start": 0, "end": 1100}, {"filename": "/usr/games/rogue.instr", "start": 1100, "end": 2482}, {"filename": "/usr/games/rogue.save", "start": 2482, "end": 13576}, {"filename": "/usr/games/rogue.scores", "start": 13576, "end": 13906}], "remote_package_size": 13906});
...
Module.print_rogue_screen = function () {
	...
	const message = {
		"type" : "dump",
		"dungeon" : grid_strings.join('\n')
	};
	this.post_rogue_screen(message);
};
...
var wasmImports = {
  __asyncjs__do_getchar: __asyncjs__do_getchar,
  ...
  clear_rogue_screen: clear_rogue_screen,
  ...
  fd_seek: _fd_seek,
  fd_write: _fd_write,
  init_rogue_screen: init_rogue_screen,
  set_rogue_screen: set_rogue_screen
};
...
// include: /opt/homebrew/Cellar/emscripten/3.1.44/libexec/src/emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
...
// end include: /opt/homebrew/Cellar/emscripten/3.1.44/libexec/src/emrun_postjs.js
